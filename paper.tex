...
We answer these questions through the example of neuroimaging analyses. The remainder of this paper 
...
We used four popular image scanners: Anchore,
Vuls and Clair to scan Docker images, and
Singularity Container Tools (Stools) to scan Singularity images. 
...
the National Vulnerability Database (NVD) for metadata about vulnerabilities.}
...
realized that. In their recent releases CentOS OVAL is deprecated and they started 
referring to Red Hat Enterprise Linux (RHEL) data}
