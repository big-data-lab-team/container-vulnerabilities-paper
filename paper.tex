...
In this section, we present and compare the scanning results of three scanners. 
...
When these images are rescanned after the update, results changed drastically. However, there are still
...
Figure~\ref{fig:graph2} shows the number of vulnerabilities that are detected by Anchore after updating these images.
