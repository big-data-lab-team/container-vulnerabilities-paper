...
the images. For that purpose, we use three different scanners. Second experiment involves updating
all these images and then rescanning them. The last experiment involves shrinking the size of the image
...
provides a description of the three scanning tools used.
