...
Therefore we are left with a total of 18 Boutiques images which include 6
...
on Docker hub.
\end{comment}
So we have a total of 38 Docker images from both BIDS Apps and Boutiques.
	Table~\ref{table1} displays the names of all the images that we took in our experiments.
Table~\ref{sing} lists 6 Singularity images taken from the Boutiques framework.
%\begin{figure}
%\csvreader[%
% respect all,%
...
\newline 2. Remove unnecessary packages.
