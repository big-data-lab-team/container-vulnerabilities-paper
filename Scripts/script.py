...
with sns.plotting_context(rc={"legend.fontsize":25,"font.size":18,"axes.titlesize":20,"font.weight":'heavy'}):
...
for idx,row in df.iterrows():
    ...
    hoz=row[11]
    ver=row[12]
    ax.text(x+hoz,y+ver,text,fontsize=13, horizontalalignment=alignment,verticalalignment=v,rotation=rot,weight='bold')
plt.show()
