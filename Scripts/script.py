...
with sns.plotting_context(rc={"legend.fontsize":25,"font.size":18,"axes.titlesize":20,"font.weight":'heavy',"legend.labelspacing":20}):
  p1=sns.relplot(x="Packages",y="Vulnerabilities",hue="OS distribution",size="CRITICAL Vulnerabilities",sizes=(300,800),data = df,palette=colors,markers=markers,style="OS distribution",height=10, aspect=2)
